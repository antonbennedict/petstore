...
- [ ] **API-First**: Is functionality exposed via REST?
- [ ] **Component-Based UI**: Are MUI components utilized?
- [ ] **Data Integrity**: Are JPA entities and DB schemas defined?
- [ ] **Cloud-Native**: Is configuration environment-driven for Render?
- [ ] **Atomic Features**: Is this a vertical slice (API + UI + DB)?
